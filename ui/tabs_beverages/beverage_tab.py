...
class BeverageTab:
    ...
    def setup_ui(self):
        ...
        tk.Label(self.frame, text="LISTA DE TRAGOS", bg=config.TAPIZ, font=("Arial", 18, "bold")).pack(ipady=25)
        ...
        content_frame = ttk.LabelFrame(main_frame, text="Tragos Disponibles", padding=10)
        ...
        self.tree = ttk.Treeview(table_frame, columns=("id", "Nombre", "Ingredientes"), show="headings", height=10, style="Treeview")
        ...
        tk.Label(combobox_frame, text="Detalle", bg=config.GRIS_BOTONES, font=("Arial", 12, "bold")).pack(pady=5)
        ...
        add_button = ttk.Button(self.button_frame, text="➕ Agregar Trago", style="Accent.TButton", command=self.add_item)
        edit_button = ttk.Button(self.button_frame, text="✏️ Modificar Trago", style="Accent.TButton", command=self.modify_item)
        delete_button = ttk.Button(self.button_frame, text="❌ Eliminar Trago", style="Accent.TButton", command=self.delete_item)
